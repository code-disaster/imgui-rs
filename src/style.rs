...
fn test_style_scaling() {
    ...
    style
        ...
        .set_display_window_padding((23.0, 24.0))
        .set_display_safe_area_padding((25.0, 26.0))
        .set_mouse_cursor_scale(27.0)
        .scale_all_sizes(2.0);
    ...
    assert_eq!(style.display_window_padding(), (46.0, 48.0));
    assert_eq!(style.display_safe_area_padding(), (50.0, 52.0));
    assert_eq!(style.mouse_cursor_scale(), 54.0);
}
